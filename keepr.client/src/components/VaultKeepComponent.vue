<template>
    ...
    <div class="cards">
      <img class="img-fluid keep-img selectable" title="View this keep" data-bs-toggle="modal" data-bs-target="#vaultKeepsView" @click="setActiveKeep(this.keepProp)" :src="keepProp.img" :alt="keepProp.name">
    </div>
